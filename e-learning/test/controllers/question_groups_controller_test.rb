...
class QuestionGroupsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create question_group" do
    assert_difference('QuestionGroup.count') do
      post question_groups_url, params: { question_group: { ident_name: @question_group.ident_name, name: @question_group.name } }
    end
  ...
  test "should update question_group" do
    patch question_group_url(@question_group), params: { question_group: { ident_name: @question_group.ident_name, name: @question_group.name } }
