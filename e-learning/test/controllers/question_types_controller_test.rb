...
class QuestionTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create question_type" do
    assert_difference('QuestionType.count') do
      post question_types_url, params: { question_type: { ident_name: @question_type.ident_name, name: @question_type.name, question: @question_type.question } }
    end
  ...
  test "should update question_type" do
    patch question_type_url(@question_type), params: { question_type: { ident_name: @question_type.ident_name, name: @question_type.name, question: @question_type.question } }
